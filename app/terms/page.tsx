export default async function Terms() {
  return (
    <section className=" mx-8 my-10 bg-black flex flex-col gap-4 sm:mx-40">
      ...
      <p>
        BigJPG.app allows you to upload and optimize images by enlarging and
        enhancing them without loss of quality. Our services are available
        through our website and may be offered through additional channels in
        the future.
      </p>
      <h2 className="font-bold text-lg">Accounts and Subscriptions</h2>
      <p>
      ...
      <p>
        ...
        the laws of United States. By using BigJPG.app, you acknowledge that you
